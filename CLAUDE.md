...
- For git push, use HTTPS URL instead of SSH: `git push https://github.com/Mohamed-Elhawary/eslint-plugin-code-style.git <branch>`. This applies to all remote operations (push, creating PRs, closing issues). Use `gh` CLI for GitHub API operations (PRs, issues).
