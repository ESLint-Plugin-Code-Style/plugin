...
**eslint-plugin-code-style** is an ESLint plugin providing 83 custom formatting rules (72 auto-fixable, 24 configurable, 11 report-only) for React/JSX projects. It's designed for ESLint v9+ flat config system.
...
**TypeScript-only rules** (74 rules in JS projects, 83 in TS projects):
...
- Currently: 72 auto-fixable rules, 24 configurable rules, 11 report-only rules
...
**Current counts:** 83 total · 72 auto-fixable 🔧 · 24 configurable ⚙️ · 11 report-only.
